    ...
    <h3>送花</h3>
        <form method="post" action="?action=send">
         <input type="hidden" name="touser" value="<?php echo $_html['touser'] ?>"
            <dl>
        <dd>
            <label><input type="text" readonly="readonly" value="TO:<?php echo $_html['touser'] ?>" class="text"/></label>
            <select name="flower">
             <?php
        ...
        <dd><label><textarea name="content">非常欣赏你，送你几朵花啦！</textarea></label></dd>
            <dd>验 证 码：<label><input type="text" name="code" class="text.yzm" /> <img src="recode.php" id="code" /><input type="submit" class="submit" value="送花" /> </label></dd>
